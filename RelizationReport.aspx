<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RelizationReport.aspx.cs" Inherits="RelizationReport" %>
                               ...
                               <%-- <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddltype" runat="server" CssClass="form-control">
                                        <asp:ListItem>Salewise</asp:ListItem>
                                        <asp:ListItem>DispatchWise</asp:ListItem>
                                        <asp:ListItem>ProductWise</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 5px;">
                                </td>
