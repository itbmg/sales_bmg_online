<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="RouteWiseAmountInv.aspx.cs" Inherits="RouteWiseAmountInv" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function BtnGetAmountDeatailsClick() {
            //window.location = "DueApproval.aspx";
            window.open("DueApproval.aspx");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Sales Office Wise Due<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Sales Office Wise Due</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Sales Office Wise Due Details
                </h3>
            </div>
            <div class="box-body">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <td style="width:5px;"></td>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlreporttype" runat="server" CssClass="inputText">
                                        <asp:ListItem>Amount Balance</asp:ListItem>
                                        <asp:ListItem>Inventory Balance</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 5px;">
                                </td>
                        ...
                        <asp:Panel ID="pnlHide" runat="server" Visible="false">
                            <div id="divPrint">
                                ...
                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="EU_DataTable"
                                    GridLines="Both" Font-Bold="true" OnRowDataBound="OnRowDataBound" OnSelectedIndexChanged="OnSelectedIndexChanged">
                        ...
                        <div id="divMainAddNewRow" class="pickupclass" style="text-align: center; height: 100%;
                            ...
                            <div id="divAddNewRow" style="border: 5px solid #A0A0A0; position: absolute; top: 30%;
                                ...
                                <input type="button" id="btnget" value="Get Inventory Details" class="btn btn-primary"
