<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NewEditLeaks.aspx.cs" Inherits="NewEditLeaks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ddlRouteNameChange(Id) {
            ...
            var s = function (msg) {
                if (msg) {
                    ...
                    $('#divFillScreen').setTemplateURL('EditLeaksAndReturns3.htm');
        ...
        function ddl_loaddata() {
            var BranchID = document.getElementById('ddlSalesOffice').value;
            var EditType = document.getElementById('ddledittype').value;
        ...
        function GetEditIndentValues() {
            ...
            if (ddlSalesOffice == "select" || ddlSalesOffice == "select") {
        ...
        function btnEditLeaksReturnsClick(id) {
            ...
            $(rows).each(function (i, obj) {
               // if ($(this).find('#txtIndentNo').text() != "" && $(this).find('#hdnProductSno').text() != "") {
                Indentdetails.push({ Tripid: $(this).find('#txtIndentNo').text(), EntryDate: $(this).find('#txtdate').text(), TableType: $(this).find('#hdntabletype').val(), Branch_id: $(this).find('#hdnbranchid').val(), Productsno: $(this).find('#hdnProductSno').val(), LeakQty: $(this).find('#txtleak').val(), PLQty: $(this).find('#hdnleak').val(), ShortQty: $(this).find('#txtShortQty').val(), PSQty: $(this).find('#hdnShortQty').val(), FreeQty: $(this).find('#txtfreeqty').val(), PFQty: $(this).find('#hdnfreeqty').val(), ReturnQty: $(this).find('#txtreturnqty').val(), PRQty: $(this).find('#hdnreturnqty').val() });
               // }
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <section class="content-header">
        <h1>
            Edit Leaks<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Edit Leaks</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Edit Leaks Details
                </h3>
            </div>
            <div class="box-body">
                <table align="center">
