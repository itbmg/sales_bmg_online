<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AvgPriceSummary.aspx.cs" Inherits="AvgPriceSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Monthly Product Wise AvgRate<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Monthly Product Wise AvgRate</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Monthly Product Wise AvgRate
                </h3>
            </div>
            <div class="box-body">
        ...
        <ContentTemplate>
            ...
            <div id="divPrint">
                <div style="width: 100%;">
                    ...
                    <div style="width: 100%;">
                        <span style="font-size: 14px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                            color: #0252aa;">Monthly Product Wise AvgRate</span><br />
                        <div>
                ...
                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" GridLines="Both"
                    Font-Size="Smaller" CssClass="table table-bordered table-hover dataTable no-footer">
