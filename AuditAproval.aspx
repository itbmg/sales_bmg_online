<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AuditAproval.aspx.cs" Inherits="AuditAproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
  ...
  <%--  <link href="Css/style.css" rel="stylesheet" type="text/css" />--%>
    ...
    <script type="text/javascript">
        ...
        function btnAuditVoucherPendingClick() {
            ...
            var AppRemarks = document.getElementById("txtAuditRemarks").value;
            var Status = "A";
            var data = { 'operation': 'btnAuditVoucherPendingClick', 'VoucherID': VoucherID, 'BranchID': branchID, 'Approvalamt': Approvalamt, 'AppRemarks': AppRemarks, 'Status': Status, 'Remarks': Remarks };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
                    $('#divMainAddNewRow').css('display', 'none');
