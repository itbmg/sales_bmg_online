<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Deliverychallan_print.aspx.cs" Inherits="Deliverychallan_print" %>
        ...
        function fillDC_Products(msg) {
            ...
            for (var i = 0; i < msg.length; i++) {
                ...
                if (itemcode == "Inventory") {
                    ...
                    results += '<td data-title="brandstatus" class="2">Packets</td>';
                    var qty = 0;
                    qty = msg[i].qty;
                    var uomqty = 0;
                    uomqty = msg[i].uomqty;
                    ...
                    var cal = 1000 / uomqty;
                    changeqty = qty * cal;
                    results += '<td data-title="brandstatus" style="bold:true;" class="2">' + parseFloat(changeqty).toFixed(2) + '</td>';
