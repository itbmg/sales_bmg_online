<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SalesOfficeWiseDue.aspx.cs" Inherits="SalesOfficeWiseDue" %>
        ...
        <ContentTemplate>
            ...
            <div id="divPrint">
                <div style="width: 100%;">
                    ...
                    <div align="center">
                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">SALESOFFICE DUE REPORT </span>
                        </div>
                    <div style="width: 100%;">
                        <br />
                        <div>
                            ...
                            <span style="color: #0252aa; font-size: 14px; margin-right: 4%;">SalesOffice Name: </span>
