<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="procurementcashform.aspx.cs" Inherits="procurementcashform" %>
   ...
   <link href="autocomplete/jquery-ui.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function FillSalesOffice() {
            var data = { 'operation': 'Getchillingcenters' };
            var s = function (msg) {
                if (msg) {
                    if (msg == "Session Expired") {
                        alert(msg);
        ...
        function BtnGenerateClick() {
            ...
            var data = { 'operation': 'btnViewprocurementVoucherGeneretaeClick', 'fromdate': fromdate, 'ToDate': ToDate, 'Type': ddlType, 'BranchID': branchID };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                                        ...
                                        <div id="divPrint">
                                            <div>
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td rowspan="2">
                                                            <img src="Images/Vyshnavilogo.png" alt=BMG width="55px" height="25px" />
                                                        </td>
                                                        <td colspan="4">
                                                            <h4>
