<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Freezer_Details_Report.aspx.cs" Inherits="Freezer_Details_Report" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Freezer Details Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Freezer Details
                </h3>
            </div>
            <div class="box-body">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlHide" runat="server" Visible="false">
                                ...
                                <div style="width: 100%;">
                                    ...
                                    <div style="width: 100%;">
                                        <span style="font-size: 18px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                                            color: #0252aa;">Freezer Details Report</span><br />
                                        <div>
                                            <div style="width: 60%; float: left; padding-left: 7%;">
                                                <span style="font-weight: bold; color: #0252aa;">Agent Name: </span>
                            ...
                            <div align="center">
                                Closing Bal
                                <asp:Label ID="Label1C" runat="server" Text="" ForeColor="Red" Style="font-size: 16px;
