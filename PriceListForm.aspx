<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PriceListForm.aspx.cs" Inherits="PriceListForm" %>
        ...
        <div class="box box-info">
            ...
            <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="Button3" Text="Generate" runat="server" 
                                        CssClass="btn btn-primary" OnClick="btnGenerate_Click" />
                                </td>
                                <%--<td style="float: left;">
                            <asp:Button ID="Button1" Text="Export To Excel" runat="server" CssClass="btn btn-primary"
                ...
                <div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="table table-bordered table-hover dataTable no-footer"
                                    GridLines="Both" Font-Bold="true" Font-Size="Smaller" OnRowCreated="grdReports_RowCreated" OnRowDataBound="grdReports_RowDataBound" OnDataBinding="grdReports_DataBinding">
                    ...
                    <div id="btnExport">
                            <asp:Button ID="Button2" Text="Export To Excel" runat="server" CssClass="btn btn-primary"
