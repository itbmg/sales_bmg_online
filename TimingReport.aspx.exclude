<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TimingReport.aspx.cs" Inherits="TimingReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Timing Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Timing Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Timing Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control">
                                        ...
                                        <asp:ListItem>Net Sales</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                 <td style="width: 5px;">
                                </td>
                                    ...
                                    <div style="width: 100%;">
                                        <div style="width: 100%;">
                                            <span style="font-size: 18px; font-weight: bold; padding-left: 27%; text-decoration: underline;
                                                color: #0252aa;">Timing Report</span><br />
                                            <div>
                                                <div>
                                                    ...
                                                    <div style="width: 20%; float: left; padding-left: 4%;">
                                                        <span style="color: #0252aa; font-size: 14px; margin-right: 4%;">Dispath Time: </span>
                                                        <asp:Label ID="lbldisptime" runat="server" ForeColor="Red" Font-Size="14px" Text=""></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            <br />
                                        ...
                                        <asp:GridView ID="grdReports" runat="server" ForeColor="White" CssClass="EU_DataTable"
