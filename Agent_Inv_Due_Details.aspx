<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Agent_Inv_Due_Details.aspx.cs" Inherits="Agent_Inv_Due_Details" %>
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Panel ID="PInventory" runat="server">
                                        <asp:DropDownList ID="ddlInvtory" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </asp:Panel>
                                </td>
                                <td style="width: 5px;">
