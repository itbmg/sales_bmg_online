...
public partial class Agen_Wise_Discount_Rate : System.Web.UI.Page
{
    MySqlCommand cmd;
    string BranchID = "";
    VehicleDBMgr vdm;
                ...
                foreach (DataColumn dc in dt.Columns)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            string olddiscountprice = "0";

                            if (oldunitprice.Rows.Count > 0)
                            {
                                olddiscountprice = oldunitprice.Rows[0]["discountprice"].ToString();
                            }
                            float DiscountUnitCost = 0;
                            float.TryParse(discountprice, out DiscountUnitCost);
                            float olddiscountUnitCost = 0;
                            float.TryParse(olddiscountprice, out olddiscountUnitCost);
